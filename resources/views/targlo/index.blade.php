...
@section('content')
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 hero-text">
					<h2>Connect With  <br><span>Targlo Research And Development</span></h2>
		...
		<div class="container">
			<div class="row">
				...
				<div class="about-img col-md-6">
					<img src="{{ asset('css\targlo\img\software-research-development-labs.png') }}" alt="" height="400px" style="position: absolute;top:120px;left:40px;">
				</div>
			</div>
	...
	<!-- selling reports section -->
	<section class="features-section spad gradient-bg">
		<div class="container text-white">
			<div class="section-title text-center">
				<h2>Targlo Includes Industries </h2>
				<p>Targlo is  one stop solution that will cater to the needs of clients in key business areas.</p>
			</div>
			<div class="row">
				<!-- feature -->
